...
public class Goral2 {
	...
	public Goral2(ArrayList<Integer> userList){
	...
	public  ArrayList<Integer> excludeNumbers(ArrayList<Integer> list,
			int from, int to){
	 ...
	 * 
	 * */
	public  ArrayList chooseNRandoms(ArrayList<Integer> list, int n){
		if (n > list.size()){
	...
	public static void main(String[] args) {
		...
		Goral2 goralTest = new Goral2(myList);
		...
		//11-Here The user write the singles numbers that he want to exclude from the list:
		 ...
		 System.out.println("\nUser want to exclude list of choosen singles numbers as following:\n "
				 +myList);
		 goralTest.excludeNumbers(goralTest.getUserList(), 34,41,47);
		 ...
		 goralTest.setUserList( goralTest.excludeNumbers(goralTest.getUserList(), 34,41,47) );
